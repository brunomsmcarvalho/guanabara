...
#se ele ainda vai se alistar ao servico militar, se é hora de se alistar, se ja passou do tempo do alistamento.
#Seu programa tb devera mostrar o tempo que falta ou que passou do prazo
